...
class Ahorcado:
  ...
  def un_jugador_nuevo(self):
    ...
    while(bandera):
      ...
      try:
        ...
        if juego == 'Gano':
          print('')
          print('la palabra es:' + str(partida._palabra_aciertos))
          Ui.linea(self)
  ...
  def dos_jugadores_nuevos(self):
    ...
    print(' Jugador 1 Ingresa el nombre del jugador 2')
    ...
    jugador1["_intentos"] =["_intentos"]* dificultad

    print('')

    print('Jugador 2 ingresa el nombre del jugador 1')
    ...
    jugador2["_intentos"] =["_intentos"]* dificultad

    print('')
    print('')

    print('Turno de ' + jugador1['_nombre'].upper())
    ...
    print('')
    print('')
    print('Turno de '+jugador2['_nombre'].upper())
